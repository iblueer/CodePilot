...
const en = {
  ...
  'settings.allowedToolsTitle': 'Allowed Tools',
  'settings.allowedToolsDesc': 'Select which tools Claude can use without manual approval. Unselected tools will be automatically denied.',
